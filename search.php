...
<?php
    ...
    if(strlen($query) >= $min_length){ // if query length is more or equal minimum length then
        ...
        $raw_results = mysqli_query("SELECT * FROM discounts
            WHERE (`name` LIKE '%".$query."%') OR (`address` LIKE '%".$query."%')") 
            or die(mysqli_error());
             
        // * means that it selects all fields, you can also write names of table columns
        // discounts is the name of our table
