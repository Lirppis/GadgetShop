...
<form name= "user_input_form" onsubmit="return validateform()" method="post" action="create_verification_request.php">
    ...
    Normal Price: <input class="text-box" type="number" name="user_normal_price"required><br>
    Student Price: <input class="text-box" type="number" name="user_student_price"required><br>
